...
Приложение **не предназначено для прямой работы с детьми**. Это инструмент
для исследователя, разработчика или логопеда, который хочет понять, где нейросеть
слаба, и собрать данные для её улучшения.
